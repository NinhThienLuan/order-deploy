import CartItemVariantDropdown from '../components/CartSidebar/CartItemVariantDropdown';
import styles from '@/features/orders/pages/CartPage.module.css';

const formatVND = (n) =>
    new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(n ?? 0);

const CartItem = ({ item, onUpdateQty, onRemove, onChangeVariant }) => {
    return (
        <div className={styles.itemRow}>
            ...
            <div className={styles.itemMain}>
                ...
                <div className={styles.itemControls}>
                    <div className={styles.variantSelectorRow}>
                        <CartItemVariantDropdown 
                            productId={item.id}
                            currentVariantId={item.variantId}
                            onChange={(newVariant) => onChangeVariant(item.id, item.variantId, newVariant)}
                        />
                    </div>
