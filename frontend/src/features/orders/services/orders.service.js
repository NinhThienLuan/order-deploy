...
const INITIAL_MOCK_ORDERS = {
    ...
    "ORD-100002": {
        ...
        items: [{ productId: "2", productName: "White Coffee", quantity: 1, unitPrice: 45000, subtotal: 45000, image: 'https://images.unsplash.com/photo-1544233726-9f1d2b27be8b?auto=format&fit=crop&w=80&q=60' }],
        timeline: [
        ...
        pricing: { subtotal: 45000, deliveryFee: 10000, discount: 0, platformFee: 2000, totalAmount: 57000 },
        customer: { customerId: "cust-2", customerName: "Tran Thi B", contactNumber: "0912345678", deliveryAddress: "12 Pasteur, Quần 1" },
        payment: { paymentMethod: "MOMO", amountPaid: 57000, paymentStatus: "Paid", paymentDate: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
        totalAmount: 57000,
    ...
    "ORD-100003": {
        ...
        items: [{ productId: "3", productName: "Americano", quantity: 3, unitPrice: 45000, subtotal: 135000, image: 'https://images.unsplash.com/photo-1544233726-9f1d2b27be8b?auto=format&fit=crop&w=80&q=60' }],
        timeline: [
            { event: "Order placed", date: new Date().toISOString(), status: "active" }
        ],
        pricing: { subtotal: 135000, deliveryFee: 0, discount: 10000, platformFee: 5000, totalAmount: 130000 },
        customer: { customerId: "cust-3", customerName: "Le Van C", contactNumber: "0987654321", deliveryAddress: "89 Lê Duẩn, Quần 1" },
        payment: { paymentMethod: "CASH", amountPaid: 130000, paymentStatus: "Pending", paymentDate: null },
        totalAmount: 130000,
...
/**
 * Fetch list of dynamic order statuses
 */
export const getOrderStatuses = async () => {
    if (USE_MOCK) {
        return ["PENDING", "PROCESSING", "PAID", "PREPARING", "READY", "COMPLETED", "CANCELED"];
    }
    const res = await apiClient.get(`/api/v1/orders/statuses`);
    return res.data.result;
};
        ...
        return new Promise((resolve) => {
            setTimeout(() => {
                ...
                const newOrder = {
                    ...
                    payment: { paymentMethod: "VNPAY", amountPaid: payload.grandTotal, paymentStatus: "Paid", paymentDate: new Date().toISOString() },
