...
public enum OrderErrorCode implements ErrorCode {
    ...
    INVALID_ORDER_AMOUNT(20006, "Request amount not match product order!", HttpStatus.BAD_REQUEST,"order.invalid_amount"),
    ...
    PRODUCT_OUT_OF_STOCK(20005, "One or more products in the order are out of stock", HttpStatus.BAD_REQUEST,
            "order.out_of_stock"),
    STORE_NOT_FOUND(20006, "Franchise store not found", HttpStatus.NOT_FOUND, "order.store_not_found"),
    STORE_NOT_ACTIVE(20007, "Franchise store is not active", HttpStatus.BAD_REQUEST, "order.store_not_active"),
    INSUFFICIENT_STOCK(20008, "Insufficient ingredient stock to fulfill the order", HttpStatus.BAD_REQUEST,
