...
public class AdminProductImageController {
    ...
    public ResponseEntity<ApiResponse<ProductDetailResponse.ImageInfo>> setPrimary(
        ...
        ProductDetailResponse.ImageInfo result = productImageService.setPrimaryImage(imageId, productId);
    ...
    public ResponseEntity<Void> deleteAllImages(@PathVariable("productId") UUID productId) {
