package fsoft.franchise.auth.infrastructure.cached.redis.service.register;
...
public class RegisterRedisService {
    ...
    public void saveRegisterData(String email, RegisterRequestDTO requestDTO) throws JsonProcessingException {
