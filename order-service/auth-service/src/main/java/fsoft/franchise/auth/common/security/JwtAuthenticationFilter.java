...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (path.equals("/api/auth/refresh") || path.equals("/api/auth/login")) {
        ...
        try {
            ...
            if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (logoutTime != null && issuedAt < logoutTime) {
                    throw new ApiException(ErrorCode.UNAUTHENTICATED, "Token has been revoked due to logout or password change.");
                }
            ...
            //Giảm thiểu rủi ro khi một token cũ (đã hết hạn) vẫn cứ "lởn vởn" trong máy người dùng.
